 ...
 */ 
public class ConversationTabTitle extends JPanel {
    private final JTabbedPane pane;
    private final JLabel label;
    private final JButton button = new TabButton();

    public ConversationTabTitle(String title, JTabbedPane pane) {
    ...
    private class TabButton extends JButton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            int i = pane.indexOfTabComponent(ConversationTabTitle.this);
            if (i != -1) {
                pane.remove(i);
            }
        }
